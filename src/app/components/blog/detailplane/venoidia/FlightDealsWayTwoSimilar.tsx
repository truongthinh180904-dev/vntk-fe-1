...
import { CalendarCheck, Gift, Plane, Star } from "lucide-react";
import React, { useEffect, useRef, useState } from "react";
import FlightDealLink from "../../../flightlink/venoidia/FlightDealLinkTwo";
...
// --- PHÂN TRANG ---
  ...
  if (sliderRef.current) {
    gsap.fromTo(
      sliderRef.current.querySelectorAll(".card"), // vì bạn đang dùng className="card"
      { opacity: 0, y: 50 },
      {
        opacity: 1,
        y: 0,
  ...
  return (
    <div className="container my-4">
      <h1
        ...
        style={{ color: "#2D4271" }}
      >
        <Gift size={40} color="#2D4271" className="mb-2" />  Vé máy bay từ {flights[0].from} cho bạn
      </h1>
         ...
         <FlightDealLink
          ...
          >
              <div
                ...
                style={{ borderRadius: "2px", overflow: "visible" }}
              >
                {/* Label MỘT CHIỀU */}
               {/* Label Ribbon */}
