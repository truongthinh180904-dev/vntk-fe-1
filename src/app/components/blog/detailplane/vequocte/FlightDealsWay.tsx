...
import FlightDealLink from "../../../flightlink/venoidia/FlightDealLinkOne";
    ...
    gsap.fromTo(
      ...
      {  y: 50 },
      {
        ...
        scrollTrigger: {
          ...
          start: "top 80%", // khi scroll tới 80% viewport
        },
      }
    );
  }
     ...
     <div ref={sliderRef} className="row">
      {currentFlights.length > 0 ? (
        currentFlights.map((flight) => (
          <div key={flight.id} className="col-md-12 col-sm-6 col-12 mb-4">
            <FlightDealLink
              from={flight.from}
              to={flight.to}
              price={flight.price}
