...
function getDynamicDate(offsetDays: number) {
  ...
  today.setDate(today.getDate() + offsetDays + 14);  // giữ +14 như bạn trước
...
export default function PopularFlights() {
  ...
  const maxIndex = Math.max(filteredFlights.length - 4, 0);
...
const sectionRef = useRef<HTMLDivElement | null>(null);
  ...
  useEffect(() => {
    if (typeof window === "undefined") return; // ✅ tránh lỗi khi render trên server
    if (!sectionRef.current) return; // ✅ đảm bảo ref đã gán
      ...
      <div className="position-relative mt-4">
        <div
          ...
          style={{
            ...
            width: `${filteredFlights.length * 20}%`, // tổng chiều rộng
                  ...
                  <div className="mb-2">
                    ...
                    >
                     ...
                     <FlightDealLink
                        ...
                        data-loader
                      >
                    <p className="btn-view-more-link d-flex align-items-center">
