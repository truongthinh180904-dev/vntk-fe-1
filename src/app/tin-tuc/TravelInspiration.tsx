...
const TravelInspiration = () => {
  ...
  return (
        <div className="container news-all news-container py-4">
        <h1 className="fw-bold mb-4 text-uppercase text-dark">Khám phá địa điểm du lịch trên khắp thế giới</h1>     
      ...
      {currentIndex < destinations.length - 5 && (
        <button
          ...
          onClick={handleNext}
          style={{ width: 45, height: 45, top:"50%" }}
        >
          <ArrowRight />
        </button>
      )}
