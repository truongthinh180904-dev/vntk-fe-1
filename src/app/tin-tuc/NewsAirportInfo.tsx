...
useEffect(() => {
  const CACHE_KEY = "news_session_4";
    ...
    try {
      ...
      if (cached) {
        ...
        if (parsed.timestamp && Date.now() - parsed.timestamp < CACHE_DURATION) {
          ...
          console.log("✅ Lấy dữ liệu flights từ cache");
          return;
        }
      }

      // ==== 2. Fetch API nếu chưa có cache hoặc cache hết hạn ====
     const res = await axios.get(
      "https://admin.vietnam-tickets.com/wp-json/wp/v2/posts",
      {
        params: {
          categories: 57,        // ID danh mục
      ...
      console.log("✅ Lấy flights từ API và lưu cache");
    } catch (err) {
              ...
              flights.map((flight) => (
                <div key={flight.id} className="col-md-3 col-10 mb-4">
                  ...
                  >
                    ...
                    <div  className="d-none d-md-block" style={{ height: "172px", overflow: "hidden" }}>
                      <img
                        src={flight.img}
