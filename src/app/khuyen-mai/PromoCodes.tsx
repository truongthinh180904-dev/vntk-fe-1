...
export default function PromoCodes() {
  ...
  const handleCopy = async (code: string, id: number) => {
   ...
   useEffect(() => {
    // Hiệu ứng xuất hiện từng card khi scroll tới
    gsap.utils.toArray(".promo-card").forEach((card: any, index) => {
      gsap.fromTo(
        card,
        {
          opacity: 0,
        ...
        },
        {
          ...
          x: 0,
          duration: 0.8,
          delay: index * 0.15, // hiệu ứng lần lượt
          ease: "power3.out",
          scrollTrigger: {
            trigger: card,
            start: "top 85%", // bắt đầu khi card gần tới vùng nhìn thấy
  ...
  return (
  // Trong component
<section className="news-container mb-5 news-all">
