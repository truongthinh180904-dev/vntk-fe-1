...
import { ArrowLeft, ArrowRight, ChevronLeft, ChevronRight, PencilLine, Rocket } from "lucide-react";
...
const TravelInspiration = () => {
  ...
  return (
    <div className="container my-5 position-relative margin-top-mobile">
