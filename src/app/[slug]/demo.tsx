...
import BlogDetailClients from "./BlogDetailData";

import banner_01 from "../assets/img/home/vemaybaynoidia/banner-promotion-01.jpg";
...
interface BlogDetailClientProps {
  ...
  breadcrumb: Category[]; // ✅ thêm dòng này
  thumnail?: string;
}
...
export default function BlogDetailClient({
  ...
  useEffect(() => {
    if (!post && slug) {
      setLoading(true);
      fetch(`https://admin.vietnam-tickets.com/wp-json/wp/v2/posts?slug=${slug}&_embed=true`)
        .then((res) => res.json())
        .then((data) => {
...
//fetch dữu liệu chuyến bay liên quan
...
// console.log("meta iata",post?.meta.fromName, post?.meta.price, post?.meta.toName);
  ...
  const renderFlightDeals = () => {
    ...
    if (activeTab === "international" && filteredInternational.length > 0 && filteredFlights.length > 0) {
        console.log("demo1",filteredInternational);
      return (
     <>
  ...
  return (
    <>
<div className="container-fluid mt-2" style={{ backgroundColor: "rgb(240, 248, 255)" }} >
      {/* máy tính  */}
     <div className="d-none d-md-block container">
      ...
      {loading ? (
        ...
        <div
          className="container-fluid d-none d-md-block blog-search text-white py-4"
          style={{
        ...
        >
          <PlaneSearch />
              ...
              <div
          className="d-block d-md-none blog-search text-white py-4"
          style={{
            backgroundImage: `url(${banner_04.src})`,
            backgroundSize: "cover",
            backgroundPosition: "center",
        ...
        <div className="container-search-mobile row gx-4 blogmargintop">
          <div className="col-lg-8 mb-4">
            ...
            <BlogContent
             {...(Number(post.meta?.price) > 0
            ? { thumnailimg: thumnail }
            : {})}
     ...
     <div className="d-block d-md-none ">
      ...
      {loading ? (
        ...
        <div className="container-search-mobile row gx-4">
          <div className="col-lg-8 mb-4">
            <div className="bg-white rounded shadow p-3 overflow-hidden blogmargintop">
              {/* <h2
                className="fw-bold mb-3"
                dangerouslySetInnerHTML={{ __html: post.title.rendered }}
              />
             ...
             {/* <div
              ...
              onContextMenu={(e) => e.preventDefault()} // chặn chuột phải
            /> */}
            {/* <BlogContent content={post.content.rendered}  />  pFaqs={post?.meta._faq_position}*/}
